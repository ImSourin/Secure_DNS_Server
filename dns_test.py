...
update.add("ns5", 300, "A", "192.168.1.4")
...
#     axfr_request = dns.query.xfr(master_ip, zone_name, rdtype=dns.rdatatype.IXFR, port=31112,
...
#
#
# udp_client("127.0.0.1", 31112, "ZONE_TRANSFER example.com")
